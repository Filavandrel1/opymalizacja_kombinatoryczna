...
void metaheurystyka() {
    ...
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    parametry.liczbaIteracji = wczytajIntZDomyslna("Liczba iteracji (domyslnie 100): ", parametry.liczbaIteracji);
    parametry.liczbaMrowek = wczytajIntZDomyslna("Liczba mrowek (domyslnie 50): ", parametry.liczbaMrowek);
    parametry.limitKandydatow = wczytajIntZDomyslna("Limit kandydatow na krok (domyslnie 2): ", parametry.limitKandydatow);
